...
# ========================
# Generated: 2026-02-17 20:43:58
# Source: create_case.sh --write-script

CASE_NUM="exp6"
PARAM_FILE="/global/homes/j/jingtao/A2MC/use_cases/Kougarok/memory/phase_results/phase5_testing/fates_params_api25.5.0_12pft_c230710__PtCNP162_En322_exp6.nc"
BASE_CASE_NAME="Kougarok_ELM-FATES_Enexp6"
...
NLEOF
    ...
    if [ -n "$REUSE_BUILD" ]; then
        REUSE_CASE="${ENSEMBLE_PREFIX}_PtCNPEn${REUSE_BUILD}_${PHASE}"
