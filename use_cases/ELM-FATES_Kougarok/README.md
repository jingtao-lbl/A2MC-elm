...
2. **`A2MC/use_cases/ELM-FATES_Kougarok/config/kougarok_config.sh`** — Kougarok-specific settings (PFTs, parameters, validation targets, case naming)
...
python orchestrator.py --resume --state-file ./use_cases/ELM-FATES_Kougarok/memory/workflow_state.json

# Monitor progress (main log file saved to use_cases/ELM-FATES_Kougarok/)
tail -f use_cases/ELM-FATES_Kougarok/a2mc_run_*.log
```

All screen output is automatically saved to `use_cases/ELM-FATES_Kougarok/a2mc_run_{timestamp}.log`.
