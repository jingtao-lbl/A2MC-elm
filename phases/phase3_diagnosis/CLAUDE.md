...
| `ai_diagnosis.py` | Claude API + rule-based diagnosis (extracted from `orchestrator.py`) |
...
| `plot_diagnostics.py` | Diagnostic figures for PFT diagnosis (6-panel composite) |
