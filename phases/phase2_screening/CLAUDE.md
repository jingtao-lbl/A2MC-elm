...
| Script | Purpose |
|--------|---------|
| `screen_ensemble.py` | Main screening workflow — rank ensemble against validation targets |
| `screening_helpers.py` | Load, perform, and analyze screening results |
| `compare_biomass_topcases.py` | Compare top cases against observations |
| `plot_screening.py` | Ensemble biomass visualization |
